...
This means all the styles are contained in a single file:
  Maven_Pro/MavenPro-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Maven Pro:
  Maven_Pro/static/MavenPro-Regular.ttf
  Maven_Pro/static/MavenPro-Medium.ttf
  Maven_Pro/static/MavenPro-SemiBold.ttf
  Maven_Pro/static/MavenPro-Bold.ttf
  Maven_Pro/static/MavenPro-ExtraBold.ttf
  Maven_Pro/static/MavenPro-Black.ttf
